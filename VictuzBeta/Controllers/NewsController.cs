...
namespace VictuzBeta.Controllers
{
    public class NewsController : Controller
    {
        ...
        public NewsController(VictuzBetaDB context)
=======
using Victuz.Data;
using Victuz.Models;
...
namespace Victuz.Controllers
{
    public class NewsController : Controller
    {
        ...
        public NewsController(VictuzDB context)
>>>>>>> 40034713999ffddfb830ed1ef18feeae66801caf
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,CreatedDate")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,CreatedDate")] News news)
        {
            if (id != news.Id)
            {
                return NotFound();
