...
{
    /// <inheritdoc />
    public partial class AddVictuzBetaDBToDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, "Workshop", null, new DateTime(2024, 12, 6, 15, 5, 16, 463, DateTimeKind.Local).AddTicks(2192), "Test Description", "Test room", "Test Name" });

            migrationBuilder.InsertData(
                table: "Agendas",
                columns: new[] { "Id", "Date", "Name" },
                values: new object[] { 1, new DateTime(2024, 12, 6, 15, 5, 16, 465, DateTimeKind.Local).AddTicks(502), "Test" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 12, 6, 15, 5, 16, 465, DateTimeKind.Local).AddTicks(3846), "Test description", "Test Title" });

            migrationBuilder.InsertData(
                table: "Propositions",
                columns: new[] { "Id", "Date", "Description", "MemberName", "MembersId", "Name", "StatusDisplay", "StatusesId" },
                values: new object[] { 1, new DateTime(2024, 12, 6, 15, 5, 16, 465, DateTimeKind.Local).AddTicks(2730), "Test", "Test", null, "Test", "In behandeling", null });
